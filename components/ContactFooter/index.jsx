...
function ContactFooter() {
  ...
  return (
    <div className=" dark:bg-bgHoverCategory bg-borderColor  rounded-2xl w-full ">
      ...
      >
        {/* Name Fields */}
        <div className={`${spaceGrotesk.className} grid grid-cols-1 md:grid-cols-2 gap-6`}>
          <div>
            <label
              htmlFor="firstName"
            ...
            <input
              ...
              className={`w-full p-3 border rounded-xl shadow-sm bg-darkForm transition duration-300
                ${
                  errors.firstName
                    ? "border-red-500"
                ...
                hover:bg-darkFormHover hover:border-zinc-700
              `}
            />
            {errors.firstName && (
          ...
          <div>
            ...
            <input
              ...
              className={`w-full p-3 border rounded-xl shadow-sm bg-darkForm transition duration-300
                ...
                focus:ring-gray-500 focus:border-gray-500
                hover:bg-darkFormHover hover:border-gray-300
              `}
            />
            {errors.lastName && (
        ...
        <div>
          ...
          <textarea
            id="message"
            rows="8" // Increased number of rows for a taller textarea
            placeholder="Tell us about your project"
            value={message}
            onChange={(e) => setMessage(e.target.value)}
            className={`w-full p-3 border bg-darkForm rounded-xl shadow-sm transition duration-300
    ${
      errors.message
        ? "border-red-500"
        : "border-gray-200 dark:bg-bgHoverCategory"
        ...
        <div className={`${spaceGrotesk.className} flex justify-end`}>
          <button
            ...
            className="  w-full text-center bg-black dark:bg-white text-white dark:text-black px-4 py-3 
                       ...
                       rounded-xl flex items-center justify-center gap-2 text-xl leading-6 font-medium group"
          >
            Send
            <svg
